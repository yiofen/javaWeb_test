...
<body style="background-color:#f2f9fd;">
    <div class="header bg-main">
        ...
        <div class="head-l">
            <a href="javascript:void(0);" class="button button-little bg-blue"><span class="icon-user"></span>${sessionScope.user.uname}(${sessionScope.user.rname})</a> &nbsp;&nbsp;
            <a class="button button-little bg-red" href="user?cmd=logout" target="_self"><span class="icon-power-off"></span>退出登录</a>
        </div>
    </div>
    <div class="leftnav">
